...
class DictionaryClassifier:
    def __init__(self, model_path=None, classifier_type="multi_class", label_dictionary=None):
        ...
        self.label_dictionary = {k: list(set(v)) for k, v in label_dictionary.items()} if label_dictionary else None
